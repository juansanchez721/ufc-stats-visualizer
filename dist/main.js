...
function getFighters(competitors) {
  ...
  fightfight.forEach(function (fighter, i) {
    ...
    var text = document.createTextNode("".concat(name, ", ").concat(fighter.id, ",  rank: ").concat(position));
    ...
    fightStats.addEventListener("click", function (event) {
      new _scripts_card__WEBPACK_IMPORTED_MODULE_2__["default"](); // axios.get(`/fighters/${fighter.id}`)
      // .then((response) => {
      // debugger

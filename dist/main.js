...
function getRankings(rankings) {
  ...
  var _loop2 = function _loop2() {
    ...
    var division = rankings[i].name; // rankings[0].competitor_rankings[0].competitor.name
...
function fighterInfo(fighterId) {
  ...
  return "yo"; //   axios.get(`/fighters/${fighterId}`)
  //   .then((response) => {
  //       debugger
  //       console.log(response.data); 
  //       return response.data
